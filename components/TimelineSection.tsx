...
import { EDUCATION_DATA } from '../src/data/education'; // 确保指向 src/data
import { Language } from '../types'; // 确保指向根目录的 types.ts
           ...
           <div className="mb-10">
             ...
             <p className="text-xl font-medium text-gray-500 dark:text-gray-400 leading-relaxed">
               {isSuccess 
                  ...
                  : (language === 'zh' ? '咱们班女生最多的时候的人数减去女生最少的人数等于几？' : 'Max girls - Min girls = ?')
               }
             </p>
           </div>
